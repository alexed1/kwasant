...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        updateResults: function (initial) {
            ...
            if (this.opts.validateFormat && search.val() !== "") {
                var result = evaluate(this.opts.validateFormat, search.val());
                if (result !== null) {
                    render("<li class='select2-no-results'>" + result + "</li>");
                    return;
                }
            }
    ...
    $.fn.select2.defaults = {
        ...
        validateFormat: function() { return null; },
