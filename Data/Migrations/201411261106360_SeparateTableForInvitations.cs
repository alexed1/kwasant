namespace Data.Migrations
{
    ...
    public partial class SeparateTableForInvitations : DbMigration
    {
        public override void Up()
        {
            ...
            Sql(@"
INSERT INTO [dbo].[Invitations] ([Id], [InvitationType], [ConfirmationStatus])
SELECT [Id], [InvitationType], [ConfirmationStatus]
  FROM [dbo].[Emails]
  WHERE Discriminator = 'InvitationDO'
");
